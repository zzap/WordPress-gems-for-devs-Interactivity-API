 ...
 */
export declare function getServerContext(namespace?: string): DeepReadonly<Record<string, unknown>>;
export declare function getServerContext<T extends object>(namespace?: string): DeepReadonly<T>;
export declare namespace getServerContext {
