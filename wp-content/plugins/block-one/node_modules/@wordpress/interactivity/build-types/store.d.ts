 ...
 */
export declare function getServerState(namespace?: string): DeepReadonly<Record<string, unknown>>;
export declare function getServerState<T extends object>(namespace?: string): DeepReadonly<T>;
